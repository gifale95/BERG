"""
Parameter validation utilities for NEST models.
...
from nest.core.exceptions import InvalidParameterError


class ValidationError(Exception):
    """Internal exception for validation errors that will be converted to appropriate NEST exceptions."""
    pass
