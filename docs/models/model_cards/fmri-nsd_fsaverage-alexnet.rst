...
(Krizhevsky et al., 2012) image features onto fMRI responses. Prior to mapping onto fMRI responses, the
...
.. list-table::
   ...
   * - **model_id**
     - | **Type:** str
       ...
       | **Valid Values:** fmri-nsd_fsaverage-alexnet
       | **Example:** "fmri-nsd_fsaverage-alexnet"
   * - **subject**
     - | **Type:** int
       | **Required:** Yes
...
* ``brain-encoding-response-generator/encoding_models/modality-fmri/train_dataset-nsd_fsaverage/model-alexnet/encoding_models_accuracy``
