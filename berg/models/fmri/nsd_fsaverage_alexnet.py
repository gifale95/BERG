...
def load_model_info():
    yaml_path = os.path.join(os.path.dirname(__file__), "..", "model_cards", "fmri-nsd_fsaverage-alexnet.yaml")
...
register_model(
    ...
    module_path="berg.models.fmri.nsd_fsaverage_alexnet",
        ...
        try:
            ...
            if self.roi is not None:
                metadata_dir = os.path.join(
                    ...
                    'train_dataset-nsd_fsaverage', 'model-alexnet',
