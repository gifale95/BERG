...
#SBATCH --job-name=eeg_fmri_fusion-invivo_things_meg_fmri_control-05_granger_causality_no_cv
...
# Run the job
python 05_granger_causality_no_cv.py --fmri_subject $fmri_subject