...
save_dir = os.path.join(args.berg_dir, 'eeg_fmri_fusion',
    'behavioral_modeling_100_voxel_neighbor', 'plots', 'rsa_surfaceplots')
...
data_dir = os.path.join(args.berg_dir, 'eeg_fmri_fusion',
    'behavioral_modeling_100_voxel_neighbor', 'stats', 'stats.npy')
...
# Save the figure
save_dir = os.path.join(args.berg_dir, 'eeg_fmri_fusion',
    'behavioral_modeling_100_voxel_neighbor', 'plots')
