...
cd /home/giffordale95/projects/brain-encoding-response-generator/github/BERG/paper_analyses/04-eeg_fmri_fusion/invivo_nsd_eeg_fmri_control/dnn_llm_modeling/02_dnn_layerwise_modeling

# Run the job
python 01_dnn_layerwise_modeling.py --subject $subject --hemisphere $hemisphere --eeg_train_trials $eeg_train_trials --time_split $time_split