...
#SBATCH --job-name=berg-04_eeg_fmri_fusion-neural_dynamics-02_quantitative_dynamics_analysis-00b_create_tfmri_rsms
...
# Run the job
python 00b_create_tfmri_rsms.py --fmri_subject $fmri_subject --roi $roi --time_window_pair $time_window_pair --use_time_bins $use_time_bins