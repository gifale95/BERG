...
#SBATCH --job-name=berg-04_eeg_fmri_fusion-neural_dynamics-02_quantitative_dynamics_analysis-02_plot_time_time_rsa
...
# Run the job
python 02_plot_time_time_rsa.py --roi $roi --time_window_pair $time_window_pair --use_time_bins $use_time_bins --correlation_measure $correlation_measure