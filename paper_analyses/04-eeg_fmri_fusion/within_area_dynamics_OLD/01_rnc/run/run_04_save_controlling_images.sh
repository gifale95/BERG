...
#SBATCH --job-name=berg-04_eeg_fmri_fusion-neural_dynamics-01_rnc-04_save_controlling_images
...
# Run the job
python 04_save_controlling_images.py --roi $roi --time_window_pair $time_window_pair