"""Get the t-fMRI responses for a randomly selected batch of N images, and then
average these univariate responses across images. This will result in one score
indicating the mean t-fMRI univariate fMRI response for that image batch.
