...
#SBATCH --job-name=berg-04_eeg_fmri_fusion-within_area_dynamics-02a_rnc-04_save_controlling_images
...
# Run the job
python 04_save_controlling_images.py --roi $roi --time_window_pair $time_window_pair --imageset $imageset