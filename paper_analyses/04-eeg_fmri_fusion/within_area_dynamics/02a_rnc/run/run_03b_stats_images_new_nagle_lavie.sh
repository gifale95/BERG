...
#SBATCH --job-name=berg-04_eeg_fmri_fusion-within_area_dynamics-02a_rnc-03b_stats_images_new
...
# Run the job
python 03b_stats_images_new.py --roi $roi --time_window_pair $time_window_pair --imageset $imageset --method 'nagle_lavie'