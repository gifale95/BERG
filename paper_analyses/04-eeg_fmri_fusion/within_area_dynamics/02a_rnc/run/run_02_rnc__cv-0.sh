...
#SBATCH --job-name=berg-04_eeg_fmri_fusion-within_area_dynamics-02a_rnc-02_rnc__cv-0
...
# Run the job
python 02_rnc.py --cv '0' --roi $roi --time_window_pair $time_window_pair --imageset $imageset