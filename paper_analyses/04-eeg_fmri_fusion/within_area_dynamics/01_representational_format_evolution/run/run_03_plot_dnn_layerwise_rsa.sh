...
#SBATCH --job-name=berg-04_eeg_fmri_fusion-within_area_dynamics-01_representational_format_evolution-03_plot_dnn_layerwise_rsa
...
# Run the job
python 03_plot_dnn_layerwise_rsa.py --images $images --dnn $dnn --normalize $normalize