...
#SBATCH --job-name=berg-eeg_fmri_fusion_ridge-hvc_selectivity-01_generate_tfmri
...
# Run the job
python 01_generate_tfmri.py --fmri_subject $fmri_subject --hemisphere $hemisphere --eeg_reps $eeg_reps