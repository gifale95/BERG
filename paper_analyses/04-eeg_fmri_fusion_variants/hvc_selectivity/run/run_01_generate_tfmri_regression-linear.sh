...
#SBATCH --job-name=berg-eeg_fmri_fusion_variants-hvc_selectivity-01_generate_tfmri_regression-linear
...
# Run the job
python 01_generate_tfmri.py --fmri_subject $fmri_subject --hemisphere $hemisphere --eeg_reps $eeg_reps --regression $regression