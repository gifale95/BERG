...
# Load the results
# =============================================================================
data_dir = os.path.join(args.berg_dir, 'eeg_fmri_fusion_variants', 'hvc_selectivity',
    'stats', f'eeg_reps-{args.eeg_reps}_regression-{args.regression}', 'stats.npy')
...
for r, roi in enumerate(rois):
    ...
    file_name = os.path.join(save_dir,
        f'univariate_resposes_{roi}_eeg_reps-{args.eeg_reps}_regression-{args.regression}.svg')
