...
#SBATCH --job-name=eeg_fmri_fusion_variants-02_train_test_encoding_fusion_3
...
# Run the job
python 02_train_test_encoding_fusion.py --fmri_subject $fmri_subject --hemisphere $hemisphere --eeg_subject $eeg_subject --eeg_reps 'average' --regression 'linear'