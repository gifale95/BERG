...
#SBATCH --job-name=eeg_fmri_fusion_variants-02_train_encoding_fusion_2
...
# Run the job
python 02_train_encoding_fusion.py --fmri_subject $fmri_subject --hemisphere $hemisphere --eeg_subject $eeg_subject --eeg_reps 'single' --regression 'ridge'