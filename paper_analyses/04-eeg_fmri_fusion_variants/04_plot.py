...
parser.add_argument('--regression', default=['linear', 'ridge'], type=list)
...
for rep in args.eeg_reps:
    for reg in args.regression:
        ...
        times = results['times']
        corr_tfmri_fmri[f'eeg_reps-{rep}_regression-{reg}'] = results['corr_tfmri_fmri']
        corr_tfmri_fmri_roi[f'eeg_reps-{rep}_regression-{reg}'] = results['corr_tfmri_fmri_roi']
        ci_corr_tfmri_fmri_roi[f'eeg_reps-{rep}_regression-{reg}'] = results['ci_corr_tfmri_fmri_roi']
        ci_corr_tfmri_fmri_roi_peak_lat[f'eeg_reps-{rep}_regression-{reg}'] = results['ci_corr_tfmri_fmri_roi_peak_lat']
