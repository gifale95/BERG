"""Create Pycortex' ROI labels based on NSD's floc-faces ROIs (OFA, FFA-1,
FFA-2, mTL-faces, aTL-faces).
...
cortex.utils.add_roi(vertex_data, name='floc-faces_'+args.hemisphere,
    with_colorbar=True)
