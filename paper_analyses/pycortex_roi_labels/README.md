...
3. Replace the overlay files in your pycortex surface folder of the subject of interest (`../anaconda3/envs/env_name/share/pycortex/db/fsaverage_nsd_sub-0*/overlays.svg`) with the overlay files from this GitHub directory (`./fsaverage_nsd_sub-0*/overlays.svg`).

4. You can now plot fMRI surfaces with the NSD subject-specific ROI labels using the Python commands:
