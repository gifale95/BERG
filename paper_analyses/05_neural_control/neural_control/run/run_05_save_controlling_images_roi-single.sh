...
#SBATCH --job-name=berg-neural_control-05_save_controlling_images_roi-single
...
# Run the job
python 05_save_controlling_images.py --subject $subject --roi_1 $roi_1 --control_roi_1 $control_roi_1