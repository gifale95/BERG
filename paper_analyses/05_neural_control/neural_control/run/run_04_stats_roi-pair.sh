...
#SBATCH --job-name=berg-neural_control-04_stats_roi-pair
...
# Run the job
python 04_stats.py --subject $subject --roi_1 'V1' --roi_2 'V4' --control_roi_1 $control_roi_1 --control_roi_2 $control_roi_2