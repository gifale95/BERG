...
#SBATCH --job-name=berg_insilico_validation-eeg_n170_faces-02_stats
...
cd /home/giffordale95/projects/brain-encoding-response-generator/github/BERG/paper_analyses/02-neural_signatures_insilico_validation/vision/eeg/n170_faces
