"""Correlate the in-silico-defined functional localizer t-value maps with the
...
# =============================================================================
    ...
    lh_tval_vivo['faces'].append(np.squeeze(nsd.fit(sub, 'lh.white',
        'fsaverage', os.path.join(data_dir, 'lh.flocfacestval.mgz'))))
    rh_tval_vivo['faces'].append(np.squeeze(nsd.fit(sub, 'rh.white',
        'fsaverage', os.path.join(data_dir, 'rh.flocfacestval.mgz'))))
    lh_tval_vivo['bodies'].append(np.squeeze(nsd.fit(sub, 'lh.white',
        'fsaverage', os.path.join(data_dir, 'lh.flocbodiestval.mgz'))))
    rh_tval_vivo['bodies'].append(np.squeeze(nsd.fit(sub, 'rh.white',
        'fsaverage', os.path.join(data_dir, 'rh.flocbodiestval.mgz'))))
    lh_tval_vivo['places'].append(np.squeeze(nsd.fit(sub, 'lh.white',
        'fsaverage', os.path.join(data_dir, 'lh.flocplacestval.mgz'))))
    rh_tval_vivo['places'].append(np.squeeze(nsd.fit(sub, 'rh.white',
        'fsaverage', os.path.join(data_dir, 'rh.flocplacestval.mgz'))))
    lh_tval_vivo['characters'].append(np.squeeze(nsd.fit(sub, 'lh.white',
        'fsaverage', os.path.join(data_dir, 'lh.flocwordtval.mgz'))))
    rh_tval_vivo['characters'].append(np.squeeze(nsd.fit(sub, 'rh.white',
        'fsaverage', os.path.join(data_dir, 'rh.flocwordtval.mgz'))))
...
# =============================================================================
    ...
    # Threshold the functional localizer t-value maps
