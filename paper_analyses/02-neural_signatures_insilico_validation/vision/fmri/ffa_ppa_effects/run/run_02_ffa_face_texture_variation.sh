...
#SBATCH --job-name=berg_insilico_validation-ffa_ppa_effects-02_ffa_face_texture_variation
...
# Run the job
python 02_ffa_face_texture_variation.py --encoding_model $encoding_model