...
#SBATCH --job-name=berg_insilico_validation-hvc_selectivity_nsd_floc_stimuli-02_stats
...
index=0
for em in 'fmri-nsd_fsaverage-alexnet' 'fmri-nsd_fsaverage-alexnet_untrained' 'fmri-nsd_fsaverage-huze' ; do
