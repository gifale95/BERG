...
save_dir = os.path.join(args.berg_dir, 'neural_signatures_insilico_validation',
    'vision', 'fmri', 'dnn_layerwise_modeling_100_voxel_neighbor', 'plots', args.encoding_model)
...
stats_dir = os.path.join(args.berg_dir,
    ...
    'dnn_layerwise_modeling_100_voxel_neighbor', 'stats', args.encoding_model, 'stats_model-'+
    args.model+'.npy')
...
for s, sub in enumerate(args.subjects):
    for hemi in ['lh', 'rh']:
        ...
        results_dir = os.path.join(args.berg_dir,
            'neural_signatures_insilico_validation', 'vision', 'fmri',
            'dnn_layerwise_modeling_100_voxel_neighbor', 'rsa', args.encoding_model, 'rsa_sub-'+
