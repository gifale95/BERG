...
save_dir = os.path.join(args.berg_dir, 'neural_signatures_insilico_validation',
    'vision', 'fmri', 'llm_modeling_100_voxel_neighbor', 'plots', args.encoding_model)
...
for sub in args.subjects:
    for hemi in ['lh', 'rh']:
        ...
        results_dir = os.path.join(args.berg_dir,
            ...
            'llm_modeling_100_voxel_neighbor', 'rsa', args.encoding_model, 'rsa_sub-'+
