...
.. list-table::
   ...
   * - train_exemplars
     - ``(22248,)``
     - Exemplar numbers per category (1–12)
   * - train_sessions
     - ``(22248,)``
   ...
   * - train_image_paths
     - ``(22248,)``
     - Relative image file paths (e.g., 'vest/vest_10s.jpg')
   ...
   * - test_exemplars
     - ``(2400,)``
     - Exemplar numbers for test images
   * - test_sessions
     - ``(2400,)``
   ...
   * - test_image_paths
     - ``(2400,)``
     - Relative image file paths for test images
   ...
   * - test_avg_image_paths
     - ``(200,)``
     - Relative image file paths for averaged test images
