...
Example usage:
python berg_creation_code/03_test_encoding_models/train_dataset-things_meg1/02_plot.py \
    --subject P1 P2 P3 P4 \
...
save_dir = os.path.join(args.berg_dir, 'encoding_models', 'modality-meg',
    'train_dataset-things_meg1', f'model-{args.model}', 'encoding_models_accuracy')
