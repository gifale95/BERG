...
Example usage:
python berg_creation_code/02_train_encoding_models/train_dataset-things_fmri_1/train_encoding_things_fmri_1.py \
    --subject sub-01 \
...
save_dir = os.path.join(args.berg_dir, 'encoding_models', 'modality-fmri',
    'train_dataset-things_fmri_1', f'model-{args.model}',
