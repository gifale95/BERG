...
'meg':
    train_things_img_ids       : (22248,) - THINGS image IDs for training (for ViT linking)
    train_categories           : (22248,) - Object category IDs (1–1854)
    train_exemplars            : (22248,) - Exemplar numbers per category (1–12)
    train_sessions             : (22248,) - Session numbers for training trials
    train_runs                 : (22248,) - Run numbers within each session
    train_image_paths          : (22248,) - Relative image file paths (e.g., 'vest/vest_10s.jpg')
    train_full_image_paths     : (22248,) - Full image paths on disk for training images
    ...
    test_categories            : (2400,)  - Object category IDs for test trials
    test_exemplars             : (2400,)  - Exemplar numbers for test images
    test_sessions              : (2400,)  - Session numbers for test trials
    test_runs                  : (2400,)  - Run numbers for test trials
    test_image_paths           : (2400,)  - Relative image file paths for test images
    test_full_image_paths      : (2400,)  - Full image paths on disk for test images
    ...
    test_avg_categories        : (200,)   - Object category IDs for averaged test images
    test_avg_image_paths       : (200,)   - Relative image file paths for averaged test images
    test_avg_full_image_paths  : (200,)   - Full image paths on disk for averaged test images
